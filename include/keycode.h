...
/**
 * @brief Key codes enumeration. For alphanumeric keys their codes are the same
 * as their char representation.
 */
enum KeyCode {
...
/**
 * @brief Key modifiers. Real modifiers state is an OR'ed combination of this
 * constants
 */
enum KeyMod {
    NONE = 0,       ///< No modifier
