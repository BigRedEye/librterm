...
inline constexpr bool is_scoped_enum_v = std::is_enum_v<Enum> && !std::is_convertible_v<Enum, std::underlying_type<Enum>>;
...
using sfinae = std::enable_if_t<is_scoped_enum_v<Enum> && ((::rterm::bitops::generate_enum_bitops_v<Enum> & ops) == ops)>;
