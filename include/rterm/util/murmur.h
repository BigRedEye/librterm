...
template<typename Byte>
inline constexpr std::pair<u64, u64> murmurhash(span<const Byte> data, const u32 seed) {
    static_assert(sizeof(Byte) == 1);
    ...
    /* canonical murmurhash implementations abuses strict aliasing rule; the following code will be optimized by
     * compilers */
    ...
    case 15:
        k2 ^= u64{static_cast<u8>(tail[14])} << 48;
    case 14:
        k2 ^= u64{static_cast<u8>(tail[13])} << 40;
    case 13:
        k2 ^= u64{static_cast<u8>(tail[12])} << 32;
    case 12:
        k2 ^= u64{static_cast<u8>(tail[11])} << 24;
    case 11:
        k2 ^= u64{static_cast<u8>(tail[10])} << 16;
    case 10:
        k2 ^= u64{static_cast<u8>(tail[9])} << 8;
    case 9:
        k2 ^= u64{static_cast<u8>(tail[8])} << 0;
        k2 *= c2;
        k2 = rotl64(k2, 33);
        k2 *= c1;
        h2 ^= k2;
    case 8:
        k1 ^= u64{static_cast<u8>(tail[7])} << 56;
    case 7:
        k1 ^= u64{static_cast<u8>(tail[6])} << 48;
    case 6:
        k1 ^= u64{static_cast<u8>(tail[5])} << 40;
    case 5:
        k1 ^= u64{static_cast<u8>(tail[4])} << 32;
    case 4:
        k1 ^= u64{static_cast<u8>(tail[3])} << 24;
    case 3:
        k1 ^= u64{static_cast<u8>(tail[2])} << 16;
    case 2:
        k1 ^= u64{static_cast<u8>(tail[1])} << 8;
    case 1:
        k1 ^= u64{static_cast<u8>(tail[0])} << 0;
        k1 *= c1;
        k1 = rotl64(k1, 31);
        k1 *= c2;
        h1 ^= k1;
